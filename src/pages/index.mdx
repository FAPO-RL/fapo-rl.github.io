...
<Figure>
  <ImageComparison slot="figure" client:load imageOne={dogsDiffc} imageTwo={dogsTrue} altTextOne="Photo of two dogs running side-by-side in shallow water, lossily compressed using the DiffC algorithm" altTextTwo="Original photo of two dogs running side-by-side in shallow water" />
...
<TwoColumns>
  ...
  <Figure slot="right">
    ...
    <Fragment slot="caption">Now look at this [Gaussian splat](https://en.wikipedia.org/wiki/Gaussian_splatting), rendered with a React component.</Fragment>
  </Figure>
</TwoColumns>
