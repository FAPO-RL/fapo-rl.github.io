...
We have also open-sourced the training dataset [FAPO-Critic](https://huggingface.co/collections/dyyyyyyyy/fapo), [training scripts](https://github.com/volcengine/verl/tree/main/recipe/fapo), and the [final checkpoint](https://huggingface.co/collections/dyyyyyyyy/fapo).
...
We have also open-sourced the [training scripts](https://github.com/volcengine/verl/tree/main/recipe/fapo), and the [final checkpoint](https://huggingface.co/collections/dyyyyyyyy/fapo).
